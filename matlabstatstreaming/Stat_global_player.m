function Stat_global_player(conn,player_match_open)
...
%% insertion SQL
pgsqlexec(conn,'delete * from grenouilleapi.public.stat_global_player')
insert(conn,'grenouilleapi.public.stat_global_player',{'account_id','mean_obs_placed','max_obs_placed','min_obs_placed','tot_obs_placed','mean_sen_placed','max_sen_placed','min_sen_placed',...
    ...
    'max_mekansm','min_mekansm','tot_mekansm'},StatPlayer);
