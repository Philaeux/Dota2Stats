...
switch nargin
    case 2
        ...
        for k=1:nb_tn
            ...
            %% init player
            player_match_open=pgsqldata(conn,['select * from public.openplayermatch inner join public.openmatch on openplayermatch.match_id=openmatch.match_id where id_tn=',num2str(list_tn(k))]);
