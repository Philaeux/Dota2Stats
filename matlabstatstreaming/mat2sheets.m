...
if success
    ...
    for i = 1:numel(jdat.sheets)
        try
            sIds(i) = jdat.sheets{1,i}.properties.sheetId;
        catch ME
    ...
    if ~isempty(wheresheet) && length(wheresheet)==1
        try
            nRows = jdat.sheets{1,wheresheet}.properties.gridProperties.rowCount;
            nCols = jdat.sheets{1,wheresheet}.properties.gridProperties.columnCount;
            sheetName = jdat.sheets{1,wheresheet}.properties.title;
        catch ME
